...
given by: $$
c(x_1, x_2, \ldots, x_{l_{\max}})=(x_1,\ldots,x_{l(x_1, x_2, \ldots, x_{l_{\max}})})
...
```{r}
contexts(model_large, type = "data.frame", cutoff = "native")
```
...
in 
```{r}
contexts(model_large, type = "data.frame", cutoff = "quantile", reverse = FALSE, frequency = "detailed")
```
