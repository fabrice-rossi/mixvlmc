# trimmed model can be drawn
    ...
    Output
      *
      ...
      |   |   |   |   '-- (1.28,7.54] (<0.12> 0.093, 0.91)
      |   |   |   '-- (1.28,7.54] (<0.9> 0.11, 0.89)
      |   |   '-- (1.28,7.54] (<0.036> [ (1.28,7.54]/(0,1.28] ~ -2.7 & 1.3 ])
      |   '-- (1.28,7.54] (<0.15> 0.16, 0.84)
      '-- (1.28,7.54]
          +-- (0,1.28] (<0.75> 0.83, 0.17)
          '-- (1.28,7.54]
              +-- (0,1.28] (<1> 0.85, 0.15)
              '-- (1.28,7.54] (collapsing: 0.0032)
                  +-- (0,1.28] (<0.029> [ (1.28,7.54]/(0,1.28] ~ 0.99 & 1.3 ])
                  '-- (1.28,7.54] (<0.72> 0.94, 0.056)
